...
#include "robot_interfaces/msg/detail/odometry__rosidl_typesupport_fastrtps_c.h"
...
using _Odometry__ros_msg_type = robot_interfaces__msg__Odometry;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__Odometry;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_interfaces__msg__Odometry * ros_message = static_cast<const robot_interfaces__msg__Odometry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_interfaces__msg__Odometry(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_interfaces__msg__Odometry * ros_message = static_cast<robot_interfaces__msg__Odometry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_interfaces__msg__Odometry(cdr, ros_message);
}

static uint32_t _Odometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__Odometry(
...
static size_t _Odometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__Odometry(
