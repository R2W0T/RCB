...
{
  new (message_memory) robot_interfaces::msg::Odometry(_init);
}

void Odometry_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_interfaces::msg::Odometry *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Odometry_message_member_array[3] = {
  {
    ...
    offsetof(robot_interfaces::msg::Odometry, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::Odometry, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces::msg::Odometry, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Odometry_message_members = {
  ...
  3,  // number of fields
  sizeof(robot_interfaces::msg::Odometry),
...
get_message_type_support_handle<robot_interfaces::msg::Odometry>()
{
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_interfaces, msg, Odometry)() {
  return &::robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Odometry_message_type_support_handle;
}
