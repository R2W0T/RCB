...
#include "robot_interfaces/msg/detail/speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::Speed & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::Speed & ros_message)
{
  // Member: linear_speed
  cdr >> ros_message.linear_speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::Speed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::Speed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::Speed *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, Speed)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
