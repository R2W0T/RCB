...
#include "robot_interfaces/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const robot_interfaces::msg::Odometry &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  robot_interfaces::msg::Odometry &);
...
cdr_serialize(
  const robot_interfaces::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::Command & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  // Member: odometry
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Odometry(
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::Command;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: odometry
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Odometry(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, Command)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
