...
int main(int argc, char *argv[]) {
    ...
    // std::string pipeline = "libcamerasrc ! video/x-raw, width=1536, height=864 ! videoconvert ! appsink";
    ...
    // std::string camera_name = "/base/axi/pcie@120000/rp1/i2c@80000/imx708@1a";
    // std::string pipeline = "libcamerasrc camera-name=" + camera_name + 
